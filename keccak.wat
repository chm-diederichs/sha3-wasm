(module
  ...
  (func $squeeze (export "squeeze") (param $ctx i32) (param $output i32) (param $digest_length i32)
    ...
    (func $f_permute (export "f_permute") (param $ctx i32)
        ...
        (i64.rotl (get_local $c_1) (i64.const 1))
        (get_local $c_4)
        (i64.xor)
        (set_local $d_0)
        ...
        (i64.rotl (get_local $c_2) (i64.const 1))
        (get_local $c_0)
        (i64.xor)
        (set_local $d_1)
        ...
        (i64.rotl (get_local $c_3) (i64.const 1))
        (get_local $c_1)
        (i64.xor)
        (set_local $d_2)
        ...
        (i64.rotl (get_local $c_4) (i64.const 1))
        (get_local $c_2)
        (i64.xor)
        (set_local $d_3)
        ...
        (i64.rotl (get_local $c_0) (i64.const 1))
        (get_local $c_3)
        (i64.xor)
        (set_local $d_4)
        ...
        (i64.rotl (get_local $a_1) (i64.const 1))
        (set_local $b_10)

        (i64.rotl (get_local $a_10) (i64.const 3))
        (set_local $b_7)

        (i64.rotl (get_local $a_7) (i64.const 6))
        (set_local $b_11)

        (i64.rotl (get_local $a_11) (i64.const 10))
        (set_local $b_17)

        (i64.rotl (get_local $a_17) (i64.const 15))
        (set_local $b_18)

        (i64.rotl (get_local $a_18) (i64.const 21))
        (set_local $b_3)

        (i64.rotl (get_local $a_3) (i64.const 28))
        (set_local $b_5)

        (i64.rotr (get_local $a_5) (i64.const 28))
        (set_local $b_16)

        (i64.rotr (get_local $a_16) (i64.const 19))
        (set_local $b_8)

        (i64.rotr (get_local $a_8) (i64.const 9))
        (set_local $b_21)

        (i64.rotr (get_local $a_21) (i64.const 62))
        (set_local $b_24)

        (i64.rotr (get_local $a_24) (i64.const 50))
        (set_local $b_4)

        (i64.rotr (get_local $a_4) (i64.const 37))
        (set_local $b_15)

        (i64.rotr (get_local $a_15) (i64.const 23))
        (set_local $b_23)

        (i64.rotr (get_local $a_23) (i64.const 8))
        (set_local $b_19)

        (i64.rotr (get_local $a_19) (i64.const 56))
        (set_local $b_13)

        (i64.rotr (get_local $a_13) (i64.const 39))
        (set_local $b_12)

        (i64.rotr (get_local $a_12) (i64.const 21))
        (set_local $b_2)

        (i64.rotr (get_local $a_2) (i64.const 2))
        (set_local $b_20)

        (i64.rotr (get_local $a_20) (i64.const 46))
        (set_local $b_14)

        (i64.rotr (get_local $a_14) (i64.const 25))
        (set_local $b_22)

        (i64.rotr (get_local $a_22) (i64.const 3))
        (set_local $b_9)

        (i64.rotr (get_local $a_9) (i64.const 44))
        (set_local $b_6)

        (i64.rotr (get_local $a_6) (i64.const 20))
        (set_local $b_1)
